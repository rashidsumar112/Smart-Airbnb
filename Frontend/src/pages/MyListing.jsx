...
function MyListing() {
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] flex items-center justify-start flex-col gap-[20px] relative overflow-x-hidden overflow-y-auto'>
      ...
      <div
        className='w-[50px] h-[50px] bg-red-700 cursor-pointer absolute top-[4%] left-[20px] rounded-[50%] flex items-center justify-center'
        onClick={() => navigate("/")}
      >
        <IoArrowBackCircle className='w-[30px] h-[30px] text-[white]' />
      </div>
